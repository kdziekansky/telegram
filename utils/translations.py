...
translations = {
    "pl": {
        ...
        "menu_mode": "🔄 Wybierz tryb czatu",
        "menu_newchat": "🆕 Nowa rozmowa",
        "menu_notes": "📝 Notatki",
        "menu_reminders": "⏰ Przypomnienia",
        "menu_credits": "💰 Kredyty",
        "menu_status": "📊 Status konta",
        "settings_choose_model": "Wybierz model AI, którego chcesz używać:",
        "welcome_message": "Witaj w {bot_name}! 🤖✨ Jestem zaawansowanym botem AI, który pomoże Ci w wielu zadaniach - od odpowiadania na pytania po generowanie obrazów.\n\n**Wpisz /onboarding aby lepiej mnie poznać i zrozumieć, jak mogę Ci pomóc w codziennych zadaniach.**\n\nDo korzystania z moich funkcji potrzebujesz kredytów. Sprawdź swoje saldo i dostępne pakiety za pomocą komendy /credits.\n\nPodstawowe komendy:\n/credits - Sprawdź kredyty i kup więcej\n/status - Sprawdź stan konta\n/newchat - Rozpocznij nowy chat z botem\n/mode - Wybierz predefiniowany prompt\n/image opis - Wygeneruj obraz\n/restart - Zrestartuj bota\n/menu - Pokaż menu główne\n/code kod - Aktywuj kod na kredyty\n\nTwój aktualny stan kredytów: {credits} kredytów",
    ...
    "en": {
        ...
        "welcome_message": "Welcome to {bot_name}! 🤖✨ I am an advanced AI bot that will help you with many tasks - from answering questions to generating images.\n\n**Type /onboarding to get to know me better and understand how I can help you with daily tasks.**\n\nTo use my features, you need credits. Check your balance and available packages using the /credits command.\n\nBasic commands:\n/credits - Check credits and buy more\n/status - Check account status\n/newchat - Start a new chat with the bot\n/mode - Choose a predefined prompt\n/image description - Generate an image\n/restart - Restart the bot\n/menu - Show main menu\n/code code - Activate code for credits\n\nYour current credit balance: {credits} credits",
    ...
    "ru": {
        ...
        "menu_mode": "🔄 Выбрать режим чата",
        "menu_newchat": "🆕 Новый разговор",
        "menu_notes": "📝 Заметки",
        "menu_reminders": "⏰ Напоминания",
        "menu_credits": "💰 Кредиты",
        "menu_status": "📊 Статус аккаунта",
        "settings_choose_model": "Выберите модель ИИ, которую вы хотите использовать:",
        "welcome_message": "Добро пожаловать в {bot_name}! 🤖✨ Я продвинутый ИИ-бот, который поможет вам во многих задачах - от ответов на вопросы до генерации изображений.\n\n**Введите /onboarding, чтобы лучше узнать меня и понять, как я могу помочь вам в повседневных задачах.**\n\nДля использования моих функций вам нужны кредиты. Проверьте свой баланс и доступные пакеты с помощью команды /credits.\n\nОсновные команды:\n/credits - Проверить кредиты и купить больше\n/status - Проверить статус аккаунта\n/newchat - Начать новый чат с ботом\n/mode - Выбрать предопределенный промпт\n/image описание - Сгенерировать изображение\n/restart - Перезапустить бота\n/menu - Показать главное меню\n/code код - Активировать код на кредиты\n\nВаш текущий баланс кредитов: {credits} кредитов",
