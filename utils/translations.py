...
translations = {
    "pl": {
        "menu_theme": "📂 Tematy rozmów",
        "menu_notes": "📝 Notatki",
        "menu_reminders": "⏰ Przypomnienia",
        "menu_export": "📤 Eksport rozmowy",
    ...
    "en": {
        "menu_theme": "📂 Conversation Themes",
        "menu_notes": "📝 Notes",
    ...
    "ru": {
        "menu_theme": "📂 Темы разговоров",
        "menu_notes": "📝 Заметки",
        "menu_reminders": "⏰ Напоминания",
        "menu_export": "📤 Экспорт разговора",
